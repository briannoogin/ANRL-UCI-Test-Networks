...
# deepFogGuardPlus
def define_deepFogGuardPlus(num_vars,num_classes,hidden_units,survive_rates,skip_hyperconnections):
    ...
    connection_f1 = Lambda(add_node_layers,name="EF2_F1")([ef1,f2f1])
