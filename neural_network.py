...
from NeuralNumber import NeuralNumber
import time
...
def fail_node(model,node_array):
    ...
    for index,node in enumerate(node_array):
        ...
        #print(model.get_layer(name = "fog3_output_layer").get_weights())
...
def print_layer_output(model,data):
        layer_output = model.get_layer(name = "fog2_output_layer").output
...
if __name__ == "__main__":
    ...
    test_model(model,validation_data,validation_labels,'validation')
